 ...
 * @date 2019/3/17
 */
public class PlaceListAdapter extends BaseQuickAdapter<SelectLocationActivity.Address, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, SelectLocationActivity.Address item) {
