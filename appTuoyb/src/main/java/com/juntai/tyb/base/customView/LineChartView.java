package com.juntai.tyb.base.customView;
...
import com.juntai.tyb.uitils.DensityUtils;
import com.juntai.tyb.uitils.PrintLog;
...
public class LineChartView extends View {
    ...
    private void drawText(Canvas canvas) {
        ...
        for(int i= 0;i<mItems.size();i++){
            ...
            if(i==0){
                ...
                canvas.drawText(String.valueOf(mItems.get(i).getTimestamp()), x - DensityUtils.dp2px(getContext(), 6), 2 * mMargin10, mPaintText);
    ...
    public static class ItemBean {
        ...
        public ItemBean(String timestamp, int value) {
            super();
            Timestamp = timestamp;
            this.value = value;
        }
