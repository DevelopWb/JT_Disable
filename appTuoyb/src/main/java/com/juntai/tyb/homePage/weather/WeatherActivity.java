...
import com.juntai.tyb.bean.weather.WeatherDaysBean;
import com.juntai.tyb.bean.weather.WeatherEveryDayBean;
import com.juntai.tyb.bean.weather.WeatherHoursBean;
...
public class WeatherActivity extends BaseMvpActivity<HomePagePresent> implements HomePageContract.IHomePageView, View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.weather_place) {
            startActivityForResult(new Intent(mContext, SelectLocationForWeatherActivity.class).putExtra("city",
                    city), SelectLocationForWeatherActivity.SELECT_LOCATION);
        } else if (id == R.id.back_btn) {
            onBackPressed();
        } else if (id == R.id.place_choose_btn) {
        }
    }
