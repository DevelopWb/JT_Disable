...
//        this.setTitle(dateTime);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewUtil.resizePicker(MyApp.width / 8 ,datePicker);
        ViewUtil.resizePicker(MyApp.width / 8 ,timePicker);
        Button cancelBtn = (Button) findViewById(R.id.btn_cancel);
        Button sureBtn = (Button) findViewById(R.id.btn_sure);
        textViewTitle =  findViewById(R.id.date_title);
...
//        this.setTitle(dateTime);
        textViewTitle.setText(dateTime);
    }
