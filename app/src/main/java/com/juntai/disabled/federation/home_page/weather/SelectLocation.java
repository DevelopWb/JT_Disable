        ...
        switch (tag) {
            case HomePageContract.GET_PRIVINCE:
                ...
                for (int j = 0; j < a.length; j++){
                    if (m == -1 && MyApp.app.getBdLocation() != null
                            && a[j].equals(MyApp.app.getBdLocation().getProvince())){
                        m = j;
                        break;
                    }
                }
                ...
                first.setOnItemSelectedListener(SelectLocation.this);
                if (m != -1){
                    first.setSelection(m);
                }
                break;
            case HomePageContract.GET_CITY:
                ...
                for (int j = 0; j < c.length; j++){
                    if (n == -1 && MyApp.app.getBdLocation() != null
                            && c[j].equals(MyApp.app.getBdLocation().getCity())){
                        n = j;
                        break;
                    }
                }
                secondAdapter = new ArrayAdapter<>(mContext, R.layout.item_spinner_text, c);
                second.setAdapter(secondAdapter);
                second.setVisibility(View.VISIBLE);
                second.setOnItemSelectedListener(SelectLocation.this);
                if (n != -1){
                    second.setSelection(n);
                }
                break;
            case HomePageContract.GET_TOWN:
                ...
                thirdAdapter = new ArrayAdapter<>(mContext, R.layout.item_spinner_text, t);
                ...
                if (t.length == 0 || t[0].equals("无")) {
                    ...
                    third.setOnItemSelectedListener(SelectLocation.this);
                }
                break;
            case HomePageContract.GET_STREET:
                ...
                fourAdapter = new ArrayAdapter<>(mContext, R.layout.item_spinner_text, d);
