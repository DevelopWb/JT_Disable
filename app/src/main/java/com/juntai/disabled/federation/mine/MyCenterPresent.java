 ...
 */
public class MyCenterPresent extends BasePresenter<IModel, MyCenterContract.BaseICenterView> implements MyCenterContract.ICenterPresent {
    ...
    public void initList() {
        ...
        menuBeans.add(new MyMenuBean("我的业务", 0, R.mipmap.my_business, MyCenterContract.CENTER_BUSINESS_TAG,
