...
//    //  测试bugly
//    private String BUGLY_APPID = "fa3b6df912";//bugly
...
//        //包括BD09LL和GCJ02两种坐标，默认是BD09LL坐标。
    ...
    public static String getAccount() {
        return getUser().getData().getAccount();
    }
    ...
    public static int getUid() {
        return getUser().getData().getUserId();
    }
    ...
    public static UnReadCountBean.DataBean getUnReadCountBean() {
        return Hawk.get(AppUtils.SP_KEY_UNREAD_COUNT);
    }
...
//        Hawk.delete(AppUtils.SP_NEWS_SAVE_DRAFTS);
    ...
    public static boolean isCompleteUserInfo(){
        if (getUser().getData().getSettleStatus() == 0){
            app.startActivity(new Intent(app, CompleteInfoActivity.class));
            return false;
