...
//            public static final String BASE = "http://192.168.124.115:8080/disabledPersonsFederation/u/app";
     ...
     * @return
     */
    public static final String SET_PWD = BASE + "/updateRetrievePaWd.shtml";
    /**
     * 修改密码
     *
     * @return
     */
    public static final String MODIFY_PWD = BASE + "/updatePaWd.shtml";
     ...
     * 退出登录
     */
    public static final String LOGIN_OUT = BASE + "/appLogout.shtml";
    /**
     * 获取用户信息
     */
