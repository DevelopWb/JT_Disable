...
import com.juntai.disabled.federation.mine.exchange_mall.AllGoodsListActivity;
import com.juntai.disabled.federation.mine.exchange_mall.HistoryListActivity;
...
//        mSmartrefreshlayout.autoRefresh();
    ...
    public void initData() {
        mScoreTv.setText(MyApp.getUser().getData().getScore() + "");
        page = 1;
        getData(true);
    }
