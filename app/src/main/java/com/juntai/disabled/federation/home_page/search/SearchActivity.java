...
import com.juntai.disabled.federation.home_page.site_manager.site_info.EmployeeDetailActivity;
...
public class SearchActivity extends BaseMvpActivity<HomePagePresent> implements HomePageContract.IHomePageView, View.OnClickListener,
    ...
    public void initView() {
        ...
        mImmersionBar.statusBarColor(com.juntai.disabled.basecomponent.R.color.white).statusBarDarkFont(true).init();
